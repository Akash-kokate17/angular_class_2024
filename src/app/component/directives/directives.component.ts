...
@Component({
  ...
  imports: [CommonModule,NumberonlyDirective,HighLightDirective,
    BackButtonDirective,CounterDirective
  ],
...
export class DirectivesComponent {
  ...
  cars: string[] = ['maruti', 'honda', 'ferrari', 'tata', 'vw'];
  flag = true;

  employees: any = [
    { id: 1, name: 'akash', salary: 2000, gender: 'male' },
    { id: 2, name: 'gita', salary: 1000, gender: 'female' },
    { id: 3, name: 'ram', salary: 5000, gender: 'male' },
    { id: 4, name: 'suresh', salary: 4000, gender: 'male' },
    { id: 5, name: 'sita', salary: 7000, gender: 'female' },
  ];

  addCar() {
    this.cars = ['maruti', 'honda', 'ferrari', 'tata', 'vw', 'BMW'];
  }

  updateSal() {
    this.employees[0].salary = 5000;
  }
  ...
  handleFormat() {
    this.tableHeading = !this.tableHeading;
  ...
  applyClasses(){
   if(this.flag){
    return {'btn':true,'btn-sm':true,'btn-success':true,'btn-dark':false,'textColor':true}
   }else{
